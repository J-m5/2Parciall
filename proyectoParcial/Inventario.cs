...
namespace proyectoParcial
{
    public partial class Inventario : Form
    {
        ...
        public Inventario(Form1 formPrincipal)
        {
            ...
            comboBoxINV.Items.AddRange(new string[] { "Todos", "Común", "Raro", "Épico" });
            comboBoxINV.SelectedIndex = 0;
            comboBoxINV.SelectedIndexChanged += Filtrar;

            MostrarInventario("Todos");
        }
        private void Filtrar(object sender, EventArgs e)
        {
            string seleccion = comboBoxINV.SelectedItem.ToString();
        ...
        private void MostrarInventario(string rareza)
        {
            ...
            dataGridViewINV.DataSource = vista;
        }
        ...
        {
            var confirmacion = MessageBox.Show("¿Confirmar si desea exportar la tabla 'Bloques' a Excel?", "Confirmar exportación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            using (var connection = new SqlConnection("Server=MARIO\\SQLEXPRESS;Database=2Parcial;Integrated Security=True;TrustServerCertificate=True"))
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    if (guardar.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        MessageBox.Show("Excelente... Tabla Bloques exportados");
                    }
                }
            }
        }
